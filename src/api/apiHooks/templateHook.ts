...
import { ITemplateUpdateRequest, Template, TemplateOptionResult, TemplateRequestResult } from "models/template";
...
export const useUpdateTemplate = (template_id: string, template: ITemplateUpdateRequest) => {
